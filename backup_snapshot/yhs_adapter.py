...
class YhsAdapter(Node):
    def __init__(self):
        ...
        self.declare_parameter('enable_lateral_gear', False)
        ...
        self.enable_lateral_gear = bool(p('enable_lateral_gear'))
    ...
    def _publish_command(self):
        ...
        if command_valid:
            ...
            if self.enable_lateral_gear and abs(lateral) >= self.lateral_threshold:
